...
class DashboardPageController{
  ...
  renderSuperAdmin(){
    ...
    this.renderNav();this.renderOverview();this.renderAuthority();this.renderCommunication();this.renderOperations();this.renderFinance();this.renderNotifications();this.renderIntegrations();this.renderRegistrationQueue();
  }
