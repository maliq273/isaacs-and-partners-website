...
export const Permissions = Object.freeze({
    ...
    AI_ADMIN: "AI_ADMIN",
    AI_LIAISE: "AI_LIAISE",
    AI_ANSWER_QUERIES: "AI_ANSWER_QUERIES",
    AI_RELAY_CLIENT: "AI_RELAY_CLIENT",
    AI_APPOINTMENT: "AI_APPOINTMENT",
    AI_PRICING: "AI_PRICING",
    AI_QUOTE_APPROVE: "AI_QUOTE_APPROVE",
    AI_IMMIGRATION: "AI_IMMIGRATION",
    AI_HR: "AI_HR",
    AI_BUSINESS_COMPLIANCE: "AI_BUSINESS_COMPLIANCE",
    AI_LEGAL: "AI_LEGAL",
