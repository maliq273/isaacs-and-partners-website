...
async function pdf(estimate:any,quote:any,client:any,org:any){
 ...
 t("Isaacs & Partners Pty(Ltd)",34,758,11,b); t("Registration: "+(org?.registration_number||"2025/474736/07"),34,742,9,f,muted); t("Tax: "+(org?.income_tax_number||"—"),34,728,9,f,muted); t(org?.email||"info@isaacsandpartners.online",34,714,9,f,muted);
 ...
 t("Quote No.",390,668,9,b,gold); t(quote?.quote_number||"Pending",390,650,11,b); t("Date",390,632,9,b,gold); t(new Date().toISOString().slice(0,10),390,616,9,f,muted);
 ...
 t("This quotation is based on the approved commercial costing. Third-party/statutory charges are included only where stated.",34,370,8,f,muted); t("Isaacs & Partners · "+(org?.website||"www.isaacsandpartners.online"),34,70,8,f,muted);
 return await d.save();
}
