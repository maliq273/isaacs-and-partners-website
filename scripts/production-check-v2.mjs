...
// Environment and obvious development placeholders. Documentation is allowed to contain setup placeholders.
...
// ES module imports. Query strings are stripped because browser imports legitimately use cache-busting query parameters.
...
// Route contract: validate every route path, not unrelated object string values.
